...
1. 初选小带轮的基准直径 $$d_{d1}$$​，应使 $$d_{d1}$$ ≥ $$({d_d})_{\min}$$​​
2. 验算带速 $$v$$，一般$$v$$ = 5 ~ 25 m/s，$$v_{\max}$$​ < 30 m/s
3. 计算大带轮的基准直径，由 $$d_{d2} = id_{d1}$$ 计算，并根据表适当圆整

（4）确定中心距 $$a$$，并选择V带的基准长度 $$L_d$$​

1. 根据带传动总体尺寸的限制条件或要求的中心距，结合带初选中心距公式，计算初定中心距 $$a_0$$

2. 计算相应的带长 $$L_{d0}$$，带的基准长度 $$L_d$$ 根据 $$L_{d0}$$ 由查表选取
